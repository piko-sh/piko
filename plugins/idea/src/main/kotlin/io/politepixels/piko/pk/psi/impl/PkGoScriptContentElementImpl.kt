...
/**
 * PSI element for Go script content inside script blocks.
 *
 * Implements PsiLanguageInjectionHost to allow the Go language plugin
 * to provide code intelligence for the Go code inside script blocks.
 *
 * @param node The AST node containing the Go script content.
 */
class PkGoScriptContentElementImpl(node: ASTNode) :
    PkPsiElementImpl(node), PsiLanguageInjectionHost {

    /**
     * Indicates whether this element can host injected language content.
     *
     * @return Always true, as Go script content always supports injection.
     */
    ...
    override fun updateText(text: String): PsiLanguageInjectionHost {
        throw UnsupportedOperationException("updateText() not supported in PK Go script content")
    }
    ...
    override fun createLiteralTextEscaper(): LiteralTextEscaper<out PsiLanguageInjectionHost> {
        return object : LiteralTextEscaper<PkGoScriptContentElementImpl>(this) {
             ...
             *
             * @return Always false, as Go script content can span multiple lines.
             */
