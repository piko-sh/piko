...
/**
 * PSI element for JSON content inside i18n blocks.
 *
 * Implements PsiLanguageInjectionHost to allow the JSON language plugin
 * to provide code intelligence for translation data inside i18n blocks.
 *
 * @param node The AST node containing the JSON content.
 */
class PkI18nContentElementImpl(node: ASTNode) :
    PkPsiElementImpl(node), PsiLanguageInjectionHost {

    /**
     * Indicates whether this element can host injected language content.
     *
     * @return Always true, as i18n content always supports injection.
     */
    ...
    override fun updateText(text: String): PsiLanguageInjectionHost {
        throw UnsupportedOperationException("updateText() not supported in PK i18n content")
    }
    ...
    override fun createLiteralTextEscaper(): LiteralTextEscaper<out PsiLanguageInjectionHost> {
        return object : LiteralTextEscaper<PkI18nContentElementImpl>(this) {
             ...
             *
             * @return Always false, as i18n content can span multiple lines.
             */
