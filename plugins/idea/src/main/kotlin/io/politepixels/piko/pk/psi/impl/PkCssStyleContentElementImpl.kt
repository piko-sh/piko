...
/**
 * PSI element for CSS content inside style blocks.
 *
 * Implements PsiLanguageInjectionHost to allow the CSS language plugin
 * to provide code intelligence for styles inside style blocks.
 *
 * @param node The AST node containing the CSS content.
 */
class PkCssStyleContentElementImpl(node: ASTNode) :
    PkPsiElementImpl(node), PsiLanguageInjectionHost {

    /**
     * Indicates whether this element can host injected language content.
     *
     * @return Always true, as CSS content always supports injection.
     */
    ...
    override fun updateText(text: String): PsiLanguageInjectionHost {
        throw UnsupportedOperationException("updateText() not supported in PK CSS content")
    }
    ...
    override fun createLiteralTextEscaper(): LiteralTextEscaper<out PsiLanguageInjectionHost> {
        return object : LiteralTextEscaper<PkCssStyleContentElementImpl>(this) {
             ...
             *
             * @return Always false, as CSS content can span multiple lines.
             */
