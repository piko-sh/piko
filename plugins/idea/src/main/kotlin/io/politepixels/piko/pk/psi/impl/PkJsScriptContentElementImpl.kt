...
/**
 * PSI element for JavaScript or TypeScript content inside script blocks.
 *
 * Used when the script block has `lang="js"` or `lang="ts"`. Implements
 * PsiLanguageInjectionHost to allow the TypeScript plugin to provide
 * code intelligence for client-side scripts.
 *
 * @param node The AST node containing the JavaScript or TypeScript content.
 */
class PkJsScriptContentElementImpl(node: ASTNode) :
    PkPsiElementImpl(node), PsiLanguageInjectionHost {

    /**
     * Indicates whether this element can host injected language content.
     *
     * @return Always true, as JS script content always supports injection.
     */
    ...
    override fun updateText(text: String): PsiLanguageInjectionHost {
        throw UnsupportedOperationException("updateText() not supported in PK JS script content")
    }
    ...
    override fun createLiteralTextEscaper(): LiteralTextEscaper<out PsiLanguageInjectionHost> {
        return object : LiteralTextEscaper<PkJsScriptContentElementImpl>(this) {
             ...
             *
             * @return Always false, as JS script content can span multiple lines.
             */
