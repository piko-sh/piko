...
description: Why a runtime watchdog ships in the framework, the tick-threshold-capture-notify model, the budget design, and why the right time to capture is the moment the symptom appears.
nav:
  sidebar:
    section: "explanation"
...
## Why this lives in the framework, not in the application
