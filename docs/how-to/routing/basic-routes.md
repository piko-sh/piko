...
- [About routing](../../explanation/about-routing.md) for why routes come from filenames.
...
- [Scenario 001: hello world](../../../examples/scenarios/001_hello_world/) for the smallest runnable page.
