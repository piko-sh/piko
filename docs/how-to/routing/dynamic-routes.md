...
Set `piko.Metadata.Status = 404` when the dynamic value does not resolve to a resource:
...
- [Scenario 004: product catalogue](../../showcase/004-product-catalogue.md) uses dynamic slug routing end-to-end.
