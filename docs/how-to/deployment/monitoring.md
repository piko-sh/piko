...
The provider you pass must satisfy `notification.ProviderPort`. See the [notification API reference](../../reference/notification-api.md) for the full interface contract and the constants for each provider name.
...
See the [notification reference](../../reference/notification-api.md) for the provider-name constants and the builder surface.
