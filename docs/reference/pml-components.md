...
| Attribute | Type | Default | Effect |
|---|---|---|---|
| `list-style` | `ordered` \| `unordered` | `ordered` | Drives the underlying list rendering. `pml-ul` shares the rendering helper but registers under its own tag. |
