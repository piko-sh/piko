...
var (
	// log is the package-level logger for the email_provider_ses package.
	log = logger.GetLogger("piko/email/email_provider_ses")
...
func init() {
	...
	SendDuration, err = Meter.Float64Histogram(
		"email.provider.ses.send.duration",
