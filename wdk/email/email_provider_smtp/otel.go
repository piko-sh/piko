...
var (
	...
	meter = otel.Meter("piko/email/email_provider_smtp")

	// sendTotal is a counter that tracks the total number of send operations.
...
func init() {
	...
	sendTotal, err = meter.Int64Counter(
		"email.provider.smtp.send.total",
	...
	sendDuration, err = meter.Float64Histogram(
		"email.provider.smtp.send.duration",
