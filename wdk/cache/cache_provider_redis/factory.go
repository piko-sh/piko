...
type Config struct {
	...
	// Password is the Redis authentication password; empty means no authentication.
	Password string

	// Namespace is a prefix added to all keys (e.g., "myapp:"). Recommended for shared Redis
	// instances to prevent key collisions.
	Namespace string
	...
	// OperationTimeout specifies the timeout for standard Redis operations. Default is 2
	// seconds.
