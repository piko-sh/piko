module piko.sh/piko/wdk/llm/llm_provider_grok
...
require (
	...
	piko.sh/piko v0.0.0
	piko.sh/piko/wdk/llm/llm_provider_openai v0.0.0
)
...
replace (
	piko.sh/piko v0.0.0 => ../../..
	piko.sh/piko/wdk/llm/llm_provider_openai v0.0.0 => ../llm_provider_openai
)
