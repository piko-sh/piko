...
// EmitModels generates Go struct types for each table in the catalogue. Model structs are
// engine-agnostic (they represent the schema, not driver calls), so this delegates to the
...
func (*ClickHouseEmitter) EmitModels(
	packageName string,
