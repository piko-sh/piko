...
package db_engine_clickhouse_test
...
func TestClickHouseEngine_Integration(t *testing.T) {
	if testing.Short() {
		t.Skip("skipping querier ClickHouse integration tests in short mode")
	}
	...
	if err != nil {
		if os.IsNotExist(err) {
			t.Skip("no testdata directory; skipping")
		}
