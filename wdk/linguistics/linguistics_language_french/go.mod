...
require (
	piko.sh/piko/wdk/linguistics/linguistics_phonetic_french v0.0.0
	piko.sh/piko/wdk/linguistics/linguistics_stemmer_french v0.0.0
	piko.sh/piko/wdk/linguistics/linguistics_stopwords_french v0.0.0
)
