...
var (
	// stopWords contains common Norwegian stop words (stoppord). Covers both Bokmal and
	// Nynorsk variants.
...
// Provider provides Norwegian stop words for text analysis. It implements the
...
// registration.
//
// Returns linguistics_domain.StopWordsProviderPort which provides Norwegian stop words.
