...
// Provider provides Swedish stop words for text analysis. It implements the
...
//
// Returns linguistics_domain.StopWordsProviderPort which provides Swedish stop words.
