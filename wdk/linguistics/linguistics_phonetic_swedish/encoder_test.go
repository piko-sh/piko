...
func TestGetLanguage(t *testing.T) {
	...
	assert.Equal(t, "swedish", enc.GetLanguage())
}
...
func TestEncode_Consistency(t *testing.T) {
	...
	words := []string{"STOCKHOLM", "KJELL", "DJUR", "SJAL"}
...
func TestEncode_CaseInsensitive(t *testing.T) {
	...
	assert.Equal(t, enc.Encode("STOCKHOLM"), enc.Encode("stockholm"))
}
...
func TestEncode_Words(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "DJ sound", input: "DJUR"},
		{name: "SJ sound", input: "SJAL"},
		{name: "STJ sound", input: "STJARNA"},
		{name: "SKJ sound", input: "SKJORTA"},
		{name: "RS pattern", input: "NORSK"},
		{name: "SK before soft vowel", input: "SKENA"},
		{name: "single letter", input: "A"},
		{name: "simple word", input: "HUS"},
		{name: "double consonant", input: "TALL"},
	}
