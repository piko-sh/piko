...
package linguistics_stemmer_hungarian
...
// Stemmer provides Hungarian word stemming using the Snowball algorithm. It implements
// the linguistics_domain.StemmerPort interface.
type Stemmer struct{}
