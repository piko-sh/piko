...
package linguistics_stemmer_spanish
...
const (
	// Language is the language code for the Spanish stemmer.
	Language = "spanish"
)
...
// Stemmer provides Spanish word stemming using the Snowball algorithm. It implements the
...
// Factory creates a new Spanish stemmer instance.
//
// Use this with linguistics_domain.RegisterStemmerFactory for explicit registration.
//
// Returns linguistics_domain.StemmerPort which is the Spanish stemmer.
// Returns error when the stemmer cannot be created.
func Factory() (linguistics_domain.StemmerPort, error) {
	return New()
}

// New creates a new Spanish Snowball stemmer.
//
// Returns *Stemmer which is the configured stemmer ready for use.
