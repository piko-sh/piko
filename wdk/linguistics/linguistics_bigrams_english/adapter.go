...
package linguistics_bigrams_english
...
// BigramAnalyser provides English character bigram frequency analysis for detecting
...
func (*BigramAnalyser) BigramFrequencyRatio(text string) (float64, bool) {
	...
	for index := 0; index < len(letters)-1; index++ {
		...
		totalBigrams++
		if _, found := englishBigrams[bigram]; !found {
			uncommonBigrams++
		}
	}
...
// Factory creates a new English bigram analyser instance.
//
...
var (
	// englishBigrams contains the most frequent English letter bigrams.
	englishBigrams = map[string]struct{}{
		"th": {}, "he": {}, "in": {}, "er": {}, "an": {},
		"re": {}, "on": {}, "at": {}, "en": {}, "nd": {},
		"ti": {}, "es": {}, "or": {}, "te": {}, "of": {},
		"ed": {}, "is": {}, "it": {}, "al": {}, "ar": {},
