...
// Provider provides Hungarian stop words for text analysis. It implements the
...
// Factory creates a new Hungarian stop words provider instance. Use this with
// linguistics_domain.RegisterStopWordsProviderFactory for explicit registration.
//
// Returns linguistics_domain.StopWordsProviderPort which is the provider instance for
