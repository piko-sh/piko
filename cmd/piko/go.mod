...
require (
	...
	piko.sh/piko/wdk/json/json_provider_sonic v0.0.0-alpha.37
	piko.sh/piko/wdk/logger/logger_integration_otel_grpc v0.0.0-alpha.37
	piko.sh/piko/wdk/logger/logger_integration_otel_http v0.0.0-alpha.37
	piko.sh/piko/wdk/logger/logger_otel_sdk v0.0.0-alpha.37
	piko.sh/piko/wdk/monitoring/monitoring_api v0.0.0-alpha.37
)
