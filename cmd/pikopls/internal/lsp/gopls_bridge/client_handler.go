...
// back into. pikopls is the client of its gopls child, so these callbacks are inert
...
// ApplyEdit refuses workspace edits originated by gopls; pikopls owns edits applied to
// the user's .pk files.
//
