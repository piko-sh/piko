...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      ...
      entry: './src/main.ts',
      name: 'PPModals',
      fileName: (format) => `ppframework.modals.${format}.js`
    },
    ...
    rollupOptions: {
      ...
      output: [
        {
          format: 'es',
          entryFileNames: 'ppframework.modals.es.js',
          plugins: [],
        },
        {
          format: 'es',
          entryFileNames: 'ppframework.modals.min.es.js',
          plugins: [terser({
            compress: {
              defaults: true,
              passes: 2,
        ...
        {
          format: 'iife',
          entryFileNames: 'ppframework.modals.min.js',
          name: 'PPModals',
          plugins: [terser({
            compress: {
              defaults: true,
