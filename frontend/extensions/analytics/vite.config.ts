...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      ...
      entry: './src/main.ts',
      name: 'PPAnalytics',
      fileName: (format) => `ppframework.analytics.${format}.js`
    },
    ...
    rollupOptions: {
      ...
      output: [
        {
          format: 'es',
          entryFileNames: 'ppframework.analytics.es.js',
          plugins: [],
        },
        {
          format: 'es',
          entryFileNames: 'ppframework.analytics.min.es.js',
          plugins: [terser({
            compress: {
              defaults: true,
              passes: 2,
        ...
        {
          format: 'iife',
          entryFileNames: 'ppframework.analytics.min.js',
          name: 'PPAnalytics',
          plugins: [terser({
            compress: {
              defaults: true,
