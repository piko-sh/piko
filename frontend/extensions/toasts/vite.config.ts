...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      ...
      entry: './src/main.ts',
      name: 'PPToasts',
      fileName: (format) => `ppframework.toasts.${format}.js`
    },
    ...
    rollupOptions: {
      ...
      output: [
        {
          format: 'es',
          entryFileNames: 'ppframework.toasts.es.js',
          plugins: [],
        },
        {
          format: 'es',
          entryFileNames: 'ppframework.toasts.min.es.js',
          plugins: [terser({
            compress: {
              defaults: true,
              passes: 2,
        ...
        {
          format: 'iife',
          entryFileNames: 'ppframework.toasts.min.js',
          name: 'PPToasts',
          plugins: [terser({
            compress: {
              defaults: true,
