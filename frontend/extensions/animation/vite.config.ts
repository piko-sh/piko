...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      ...
      entry: './src/main.ts',
      name: 'PPAnimation',
      fileName: (format) => `ppframework.animation.${format}.js`
    },
    ...
    rollupOptions: {
      ...
      output: [
        {
          format: 'es',
          entryFileNames: 'ppframework.animation.es.js',
          plugins: [],
        },
        {
          format: 'es',
          entryFileNames: 'ppframework.animation.min.es.js',
          plugins: [terser({
            compress: {
              defaults: true,
              passes: 2,
        ...
        {
          format: 'iife',
          entryFileNames: 'ppframework.animation.min.js',
          name: 'PPAnimation',
          plugins: [terser({
            compress: {
              defaults: true,
