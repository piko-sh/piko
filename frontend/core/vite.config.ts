...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      ...
      entry: './src/main.ts',
      name: 'PPFramework',
      fileName: (format) => `ppframework.core.${format}.js`
    },
    ...
    rollupOptions: {
      output: [
        {
          format: 'es',
          entryFileNames: 'ppframework.core.es.js',
          plugins: [],
        },
        {
          format: 'es',
          entryFileNames: 'ppframework.core.min.es.js',
          plugins: [terser({
            compress: {
              defaults: true,
              passes: 4,
        ...
        {
          format: 'umd',
          entryFileNames: 'ppframework.core.min.umd.js',
          name: 'PPFramework',
          plugins: [terser({
            compress: {
              defaults: true,
