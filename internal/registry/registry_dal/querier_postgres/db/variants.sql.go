...
const deletevarianttagsforartefact = `DELETE FROM registry_variant_tag WHERE artefact_id = $1 AND release_id = $2;`
...
const deletevariantsforartefact = `DELETE FROM registry_variant WHERE artefact_id = $1 AND release_id = $2;`
...
const insertvariant = `INSERT INTO registry_variant (artefact_id, release_id, variant_id, storage_key, storage_backend_id, mime_type, size_bytes, status, created_at)
...
const insertvarianttag = `INSERT INTO registry_variant_tag (artefact_id, release_id, variant_id, tag_key, tag_value)
VALUES ($1, $2, $3, $4, $5);`
