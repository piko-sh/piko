...
const deletedesiredprofilesforartefact = `DELETE FROM registry_desired_profile WHERE artefact_id = $1 AND release_id = $2;`
...
const insertdesiredprofile = `INSERT INTO registry_desired_profile (artefact_id, release_id, name, capability_name, priority, params_json, tags_json, depends_on_json)
