...
var (
	//go:embed artefact_meta.fbs
	schemaContent []byte

	// SchemaHash is the SHA-256 hash of artefact_meta.fbs, computed at init time. This hash
...
// Pack wraps a serialised Registry FlatBuffer with the schema version hash. The returned
