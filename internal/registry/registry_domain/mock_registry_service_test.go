...
func TestMockRegistryService_AddVariant(t *testing.T) {
	...
	t.Run("nil AddVariantFunc returns zero values", func(t *testing.T) {
		...
		assert.Nil(t, got)
		assert.NoError(t, err)
		assert.Equal(t, int64(1), m.AddVariantCallCount.Load())
	})
...
func TestMockRegistryService_DeleteArtefact(t *testing.T) {
	...
	t.Run("nil DeleteArtefactFunc returns zero values", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.Equal(t, int64(1), m.DeleteArtefactCallCount.Load())
	})
...
func TestMockRegistryService_GetVariantData(t *testing.T) {
	...
	t.Run("nil GetVariantDataFunc returns zero values", func(t *testing.T) {
		...
		assert.Nil(t, got)
		assert.NoError(t, err)
		assert.Equal(t, int64(1), m.GetVariantDataCallCount.Load())
	})
...
func TestMockRegistryService_GetVariantChunk(t *testing.T) {
	...
	t.Run("nil GetVariantChunkFunc returns zero values", func(t *testing.T) {
		...
		assert.Nil(t, got)
		assert.NoError(t, err)
		assert.Equal(t, int64(1), m.GetVariantChunkCallCount.Load())
	})
...
func TestMockRegistryService_GetVariantDataRange(t *testing.T) {
	...
	t.Run("nil GetVariantDataRangeFunc returns zero values", func(t *testing.T) {
		...
		assert.Nil(t, got)
		assert.NoError(t, err)
		assert.Equal(t, int64(1), m.GetVariantDataRangeCallCount.Load())
	})
...
func TestMockRegistryService_GetBlobStore(t *testing.T) {
	...
	t.Run("nil GetBlobStoreFunc returns zero values", func(t *testing.T) {
		...
		assert.Nil(t, got)
		assert.NoError(t, err)
		assert.Equal(t, int64(1), m.GetBlobStoreCallCount.Load())
	})
...
func TestMockRegistryService_ArtefactEventsPublished(t *testing.T) {
	...
	t.Run("nil ArtefactEventsPublishedFunc returns zero values", func(t *testing.T) {
		...
		assert.Equal(t, int64(1), m.ArtefactEventsPublishedCallCount.Load())
	})
...
func TestMockRegistryService_ConcurrentAccess(t *testing.T) {
	...
	assert.Equal(t, int64(goroutines), m.AddVariantCallCount.Load())
	assert.Equal(t, int64(goroutines), m.DeleteArtefactCallCount.Load())
	...
	assert.Equal(t, int64(goroutines), m.GetVariantDataCallCount.Load())
	assert.Equal(t, int64(goroutines), m.GetVariantChunkCallCount.Load())
	assert.Equal(t, int64(goroutines), m.GetVariantDataRangeCallCount.Load())
	assert.Equal(t, int64(goroutines), m.GetBlobStoreCallCount.Load())
	assert.Equal(t, int64(goroutines), m.PopGCHintsCallCount.Load())
	assert.Equal(t, int64(goroutines), m.ArtefactEventsPublishedCallCount.Load())
}
