...
// MockEventBus is a test double for orchestrator_domain.EventBus where nil function
...
// Takes handler (orchestrator_domain.EventHandler) which is the callback to invoke for
// each event.
//
