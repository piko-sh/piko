...
// SchemaHash is the SHA-256 hash of action_manifest.fbs, computed at init time.
...
// Pack wraps a serialised Action Manifest FlatBuffer with the schema version
// hash. The returned slice has format: [32-byte hash][payload].
