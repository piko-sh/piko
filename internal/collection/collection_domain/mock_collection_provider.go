...
// MockCollectionProvider is a test double for CollectionProvider that returns zero values
...
type MockCollectionProvider struct {
	...
	// DiscoverCollectionsFunc is the function called by DiscoverCollections.
	...
	// ValidateTargetTypeFunc is the function called by ValidateTargetType.
	ValidateTargetTypeFunc func(targetType ast.Expr) error

	// FetchStaticContentFunc is the function called by FetchStaticContent.
	...
	// GenerateRuntimeFetcherFunc is the function called by GenerateRuntimeFetcher.
	...
	// GenerateRevalidatorFunc is the function called by GenerateRevalidator.
	...
	// TypeCallCount tracks how many times Type was called.
	TypeCallCount atomic.Int64

	// DiscoverCollectionsCallCount tracks how many times DiscoverCollections was called.
	DiscoverCollectionsCallCount atomic.Int64

	// ValidateTargetTypeCallCount tracks how many times ValidateTargetType was called.
	ValidateTargetTypeCallCount atomic.Int64

	// FetchStaticContentCallCount tracks how many times FetchStaticContent was called.
	FetchStaticContentCallCount atomic.Int64

	// GenerateRuntimeFetcherCallCount tracks how many times GenerateRuntimeFetcher was
	// called.
	GenerateRuntimeFetcherCallCount atomic.Int64

	// ComputeETagCallCount tracks how many times ComputeETag was called.
	ComputeETagCallCount atomic.Int64

	// ValidateETagCallCount tracks how many times ValidateETag was called.
	ValidateETagCallCount atomic.Int64

	// GenerateRevalidatorCallCount tracks how many times GenerateRevalidator was called.
	GenerateRevalidatorCallCount atomic.Int64
}

var (
	_ CollectionProvider = (*MockCollectionProvider)(nil)
)
...
// Takes config (collection_dto.ProviderConfig) which provides the provider configuration.
//
...
func (m *MockCollectionProvider) DiscoverCollections(ctx context.Context, config collection_dto.ProviderConfig) ([]collection_dto.CollectionInfo, error) {
	m.DiscoverCollectionsCallCount.Add(1)
...
func (m *MockCollectionProvider) ValidateTargetType(targetType ast.Expr) error {
	m.ValidateTargetTypeCallCount.Add(1)
...
func (m *MockCollectionProvider) FetchStaticContent(ctx context.Context, collectionName string, source collection_dto.ContentSource) ([]collection_dto.ContentItem, error) {
	m.FetchStaticContentCallCount.Add(1)
...
// Takes collectionName (string) which identifies the collection by name.
// Takes targetType (ast.Expr) which is the AST expression for the target type.
// Takes options (collection_dto.FetchOptions) which provides fetch configuration options.
//
...
func (m *MockCollectionProvider) GenerateRuntimeFetcher(
	...
	m.GenerateRuntimeFetcherCallCount.Add(1)
...
// Takes collectionName (string) which identifies the collection by name.
// Takes targetType (ast.Expr) which is the AST expression for the target type.
// Takes config (collection_dto.HybridConfig) which provides the hybrid revalidation
// configuration.
//
...
func (m *MockCollectionProvider) GenerateRevalidator(ctx context.Context, collectionName string, targetType ast.Expr, config collection_dto.HybridConfig) (*collection_dto.RuntimeFetcherCode, error) {
	m.GenerateRevalidatorCallCount.Add(1)
