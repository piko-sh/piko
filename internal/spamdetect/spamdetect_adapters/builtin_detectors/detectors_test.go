...
func TestHoneypotDetector_Filled(t *testing.T) {
	...
	schema := spamdetect_dto.MustNewSchema(spamdetect_dto.Honeypot("_hp"))
...
func TestGibberishDetector_RandomString(t *testing.T) {
	...
	schema := spamdetect_dto.MustNewSchema(spamdetect_dto.NameField("name", spamdetect_dto.SignalGibberish))
...
func TestGibberishDetector_PerSchemaThreshold(t *testing.T) {
	t.Parallel()
	detector := NewGibberishDetector(0.6, nil)
	schema := spamdetect_dto.MustNewSchema(
...
func TestGibberishDetector_EmptyFields(t *testing.T) {
	t.Parallel()
	detector := NewGibberishDetector(0.6, nil)
	schema := spamdetect_dto.MustNewSchema(spamdetect_dto.TextField("name", spamdetect_dto.SignalGibberish))
...
func TestLinkDensityDetector_ManyLinks(t *testing.T) {
	...
	schema := spamdetect_dto.MustNewSchema(spamdetect_dto.TextField("message", spamdetect_dto.SignalLinkDensity))
	submission := &spamdetect_dto.Submission{
		Fields: map[string]spamdetect_dto.FieldValue{
...
func TestBlocklistDetector_Match(t *testing.T) {
	...
	schema := spamdetect_dto.MustNewSchema(spamdetect_dto.TextField("message", spamdetect_dto.SignalBlocklist))
	submission := &spamdetect_dto.Submission{
...
func TestLanguageOnSchema_Single(t *testing.T) {
	t.Parallel()
	schema := spamdetect_dto.MustNewSchema(spamdetect_dto.Language("en"))
...
func (m *mockRegistrationService) IsEnabled(_ context.Context) bool        { return false }
func (m *mockRegistrationService) GetDetectors(_ context.Context) []string { return nil }
func (m *mockRegistrationService) HasDetector(_ context.Context, _ string) bool {
	return false
}
...
func TestGibberishDetector_ContextCancelled(t *testing.T) {
	...
	detector := NewGibberishDetector(0.6, nil)
	schema := spamdetect_dto.MustNewSchema(spamdetect_dto.TextField("message", spamdetect_dto.SignalGibberish))
	submission := &spamdetect_dto.Submission{
