...
func testSchema(signals ...spamdetect_dto.Signal) *spamdetect_dto.Schema {
	return spamdetect_dto.MustNewSchema(
...
func TestSpamDetectService_HasDetector(t *testing.T) {
	...
	assert.True(t, service.HasDetector(context.Background(), "test"))
	assert.False(t, service.HasDetector(context.Background(), "nonexistent"))
}
