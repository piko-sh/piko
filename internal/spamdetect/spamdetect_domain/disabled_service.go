...
func (*DisabledSpamDetectService) IsEnabled(_ context.Context) bool { return false }
...
// GetDetectors returns nil.
//
// Returns []string which is always nil.
func (*DisabledSpamDetectService) GetDetectors(_ context.Context) []string { return nil }

// HasDetector returns false.
//
// Returns bool which is always false.
func (*DisabledSpamDetectService) HasDetector(_ context.Context, _ string) bool { return false }

// ListDetectors returns nil.
//
// Returns []provider_domain.ProviderInfo which is always nil.
