...
// MaxFeedbackCacheSize returns the upper bound on feedback cache entries.
//
// Returns int which is the maximum allowed cache size.
func MaxFeedbackCacheSize() int {
	return maxFeedbackCacheSize
}
