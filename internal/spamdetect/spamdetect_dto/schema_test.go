...
func TestNewSchema_Honeypot(t *testing.T) {
	t.Parallel()
	schema := MustNewSchema(Honeypot("_hp"))
...
func TestNewSchema_Timing(t *testing.T) {
	t.Parallel()
	schema := MustNewSchema(Timing("_ts"))
...
func TestNewSchema_Threshold(t *testing.T) {
	t.Parallel()
	schema := MustNewSchema(Threshold(0.5))
...
func TestFieldEntry_Weight(t *testing.T) {
	t.Parallel()
	schema := MustNewSchema(TextField("message").Weight(3.0))
	assert.InDelta(t, 3.0, schema.Fields()[0].Weight, 0.01)
}

func TestFieldEntry_MaxLength(t *testing.T) {
	t.Parallel()
	schema := MustNewSchema(TextField("message").MaxLength(100))
...
func TestFieldGroup_Composability(t *testing.T) {
	...
	schemaA := MustNewSchema(personalFields, TextField("message", SignalBlocklist))
	schemaB := MustNewSchema(personalFields, TextField("notes", SignalLinkDensity))
...
func TestFieldGroup_IsolatesMutations(t *testing.T) {
	...
	schemaA := MustNewSchema(group)
	schemaB := MustNewSchema(group)
...
func TestSchema_NilEntries(t *testing.T) {
	t.Parallel()
	schema := MustNewSchema(nil, TextField("message"), nil)
...
func TestSchema_MaxFields(t *testing.T) {
	...
	for index := range entries {
		entries[index] = TextField(fmt.Sprintf("field_%03d", index))
	}
	schema, err := NewSchema(entries...)
	assert.ErrorIs(t, err, ErrSchemaTooManyFields)
...
func TestSchema_CustomSignal(t *testing.T) {
	...
	schema := MustNewSchema(TextField("message", customSignal))
...
func TestSchema_Meta_Single(t *testing.T) {
	t.Parallel()
	schema := MustNewSchema(Meta("site", "example.com"))
...
func TestSchema_Meta_CapsAtMaxDetectorOptions(t *testing.T) {
	...
	schema, err := NewSchema(entries...)
	assert.ErrorIs(t, err, ErrSchemaCapExceeded)
...
func TestSchema_CaptureHeader_Single(t *testing.T) {
	t.Parallel()
	schema := MustNewSchema(CaptureHeader("X-Forwarded-For"))
...
func TestSchema_Language_Single(t *testing.T) {
	t.Parallel()
	schema := MustNewSchema(Language("en"))
...
func TestSchema_OnAsyncResult(t *testing.T) {
	...
	schema := MustNewSchema(OnAsyncResult(handler))
