...
// shorthandExpander is a function type that expands shorthand properties into their full
// key-value pairs.
...
var (
	...
	shorthandExpanderMap = map[string]shorthandExpander{
	...
	// shorthandLonghands maps shorthand property names to their longhand equivalents, used
	// for distributing CSS-wide keywords.
	shorthandLonghands = map[string][]string{
...
//
// CSS-wide keywords (inherit, initial, unset, revert) are not expanded here because the
// email path keeps shorthands as-is. Use expandCSSWideKeyword to distribute keywords to
// longhands when needed (e.g. for layout).
//
// Takes propName (string) which is the CSS property name to expand.
// Takes value (string) which is the property value to expand.
//
// Returns map[string]string which maps longhand property names to values, or nil if the
// property is not a shorthand, cannot be expanded, or the value is a CSS-wide keyword.
...
// expandCSSWideKeyword distributes a CSS-wide keyword (inherit, initial, unset, revert)
// across all longhands of a shorthand property.
//
// Takes propName (string) which is the shorthand property name.
// Takes value (string) which is the CSS-wide keyword.
//
// Returns map[string]string with all longhands set to the keyword, or nil if the property
// is not a known shorthand.
...
// isCSSWideKeyword checks if a value is a CSS-wide keyword that should not be expanded.
//
// Takes value (string) which is the CSS property value to check.
//
// Returns bool which is true if the value is inherit, initial, unset, or revert.
