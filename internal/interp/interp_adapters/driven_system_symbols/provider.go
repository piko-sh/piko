...
func NewProvider() *SystemSymbolsProvider {
	return &SystemSymbolsProvider{}
}

// Exports returns the vendored symbol table.
//
// Returns the global Symbols map containing all registered stdlib symbols.
func (*SystemSymbolsProvider) Exports() interp_domain.SymbolExports {
	return Symbols
}
