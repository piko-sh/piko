...
// resolution. Each is a TEXT symbol in vm_dispatch_arm64.s - jump targets, not called
// from Go.
//
//go:noescape
...
// handlerBitAndNot performs a bitwise AND-NOT of two registers in the dispatch loop.
//
//go:noescape
func handlerBitAndNot() //nolint:unused // ASM handler

// handlerShiftLeft performs a bitwise left shift on a register in the dispatch loop.
//
//go:noescape
func handlerShiftLeft() //nolint:unused // ASM handler

// handlerShiftRight performs a bitwise right shift on a register in the dispatch loop.
//
//go:noescape
...
// handlerEqInt compares two integer registers for equality in the dispatch loop.
//
//go:noescape
func handlerEqInt() //nolint:unused // ASM handler

// handlerNeInt compares two integer registers for inequality in the dispatch loop.
//
//go:noescape
func handlerNeInt() //nolint:unused // ASM handler

// handlerLtInt compares two integer registers for less-than in the dispatch loop.
//
//go:noescape
func handlerLtInt() //nolint:unused // ASM handler

// handlerLeInt compares two integer registers for less-than-or-equal in the dispatch
// loop.
//
//go:noescape
func handlerLeInt() //nolint:unused // ASM handler

// handlerGtInt compares two integer registers for greater-than in the dispatch loop.
//
//go:noescape
func handlerGtInt() //nolint:unused // ASM handler

// handlerGeInt compares two integer registers for greater-than-or-equal in the dispatch
// loop.
//
//go:noescape
...
// handlerJumpIfTrue performs a conditional jump when the condition register is true.
//
//go:noescape
func handlerJumpIfTrue() //nolint:unused // ASM handler

// handlerJumpIfFalse performs a conditional jump when the condition register is false.
//
//go:noescape
...
// handlerLeIntConstJumpFalse compares a register against an integer constant and jumps if
// not less-than-or-equal.
//
//go:noescape
func handlerLeIntConstJumpFalse() //nolint:unused // ASM handler

// handlerLtIntConstJumpFalse compares a register against an integer constant and jumps if
// not less-than.
//
//go:noescape
func handlerLtIntConstJumpFalse() //nolint:unused // ASM handler

// handlerEqIntConstJumpFalse compares a register against an integer constant and jumps if
// not equal.
//
//go:noescape
func handlerEqIntConstJumpFalse() //nolint:unused // ASM handler

// handlerEqIntConstJumpTrue compares a register against an integer constant and jumps if
// equal.
//
//go:noescape
func handlerEqIntConstJumpTrue() //nolint:unused // ASM handler

// handlerGeIntConstJumpFalse compares a register against an integer constant and jumps if
// not greater-than-or-equal.
//
//go:noescape
func handlerGeIntConstJumpFalse() //nolint:unused // ASM handler

// handlerGtIntConstJumpFalse compares a register against an integer constant and jumps if
// not greater-than.
//
//go:noescape
...
// handlerIncIntJumpLt increments an integer register and jumps if the result is less-than
// a threshold.
//
//go:noescape
func handlerIncIntJumpLt() //nolint:unused // ASM handler

// handlerLoadIntConstSmall loads a small integer constant embedded in the opcode into a
// register.
//
//go:noescape
...
// handlerEqFloat compares two floating-point registers for equality in the dispatch loop.
//
//go:noescape
func handlerEqFloat() //nolint:unused // ASM handler

// handlerNeFloat compares two floating-point registers for inequality in the dispatch
// loop.
//
//go:noescape
func handlerNeFloat() //nolint:unused // ASM handler

// handlerLtFloat compares two floating-point registers for less-than in the dispatch
// loop.
//
//go:noescape
func handlerLtFloat() //nolint:unused // ASM handler

// handlerLeFloat compares two floating-point registers for less-than-or-equal in the
// dispatch loop.
//
//go:noescape
func handlerLeFloat() //nolint:unused // ASM handler

// handlerGtFloat compares two floating-point registers for greater-than in the dispatch
// loop.
//
//go:noescape
func handlerGtFloat() //nolint:unused // ASM handler

// handlerGeFloat compares two floating-point registers for greater-than-or-equal in the
// dispatch loop.
//
//go:noescape
