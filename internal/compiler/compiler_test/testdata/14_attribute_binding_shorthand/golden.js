...
<div>
  <a :data-id="state.id" {P: state.id} :href="state.url" {P: state.url}>
    "Link"
  </a>
  <img :src="state.imgSrc" {P: state.imgSrc} />
...
(() => {
    ...
    class AttrShorthandElement extends PPElement {
        constructor () {
            super();
    ...
    customElements.define("attr-shorthand", AttrShorthandElement);
})();