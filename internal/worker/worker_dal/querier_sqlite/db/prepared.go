...
func Prepare(ctx context.Context, db *sql.DB) (*PreparedDBTX, error) {
	staticQueries := []string{insertjobroot, insertjobrootwithuniquekey, appendjobversion, insertjobrootbatch, appendjobversionbatch, claimcandidates, promotecandidates, getjob, listjobversions, getjobindex, stalerunningjobs, getjobidbyuniquekey, countpendingjobs, countclaimablejobs, countnonterminaljobs, heartbeatjob}
