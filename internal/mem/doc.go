...
//
// These functions avoid allocation by creating values that share underlying memory, or
// provide direct access to memory layout information. Callers must adhere to the safety
// contracts documented on each function.
//
// # When to use
//
// Use these helpers when profiling shows memory operations are a bottleneck. Prefer safe
...
// operations. This is useful for debugging memory issues or running in environments that
