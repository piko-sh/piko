...
func TestJoinLocalePath(t *testing.T) {
	testCases := []struct {
		...
		{
			name:     "preserves directory-index trailing slash",
			locale:   "fr",
			href:     "/articles/",
...
func TestTransformHrefForLocale_DifferentStrategies(t *testing.T) {
	testCases := []struct {
		...
		{
			name:            "prefix_except_default strategy with default locale",
			href:            "/about",
			locale:          "en",
		...
		{
			name:            "prefix_except_default root for non-default locale has no trailing slash",
			href:            "/",
			locale:          "fr",
			strategy:        "prefix_except_default",
			defaultLocation: "en",
		...
		{
			name:            "prefix_except_default root for default locale stays root",
			href:            "/",
			locale:          "en",
			strategy:        "prefix_except_default",
			defaultLocation: "en",
		...
		{
			name:            "prefix strategy root for locale has no trailing slash",
			href:            "/",
			locale:          "fr",
			strategy:        "prefix",
			defaultLocation: "en",
