...
// MockCollectionService is a test double for CollectionServicePort where nil function
// fields return zero values and call counts are tracked atomically.
type MockCollectionService struct {
	// ProcessGetCollectionCallFunc is the function called by ProcessGetCollectionCall.
	...
	// ProcessCollectionDirectiveFunc is the function called by ProcessCollectionDirective.
	...
	// ProcessGetCollectionCallCallCount tracks how many times ProcessGetCollectionCall was
	// called.
	ProcessGetCollectionCallCallCount atomic.Int64

	// ProcessCollectionDirectiveCallCount tracks how many times ProcessCollectionDirective
	// was called.
	ProcessCollectionDirectiveCallCount atomic.Int64
}

var (
	_ CollectionServicePort = (*MockCollectionService)(nil)
)
...
// Takes targetTypeExpr (goast.Expr) which is the AST expression for the target type.
...
func (m *MockCollectionService) ProcessGetCollectionCall(
	...
	m.ProcessGetCollectionCallCallCount.Add(1)
...
// ProcessCollectionDirective delegates to ProcessCollectionDirectiveFunc if set.
//
// Takes ctx (context.Context) which carries deadlines and cancellation signals.
// Takes directive (*collection_dto.CollectionDirectiveInfo) which contains the collection
...
func (m *MockCollectionService) ProcessCollectionDirective(
	...
	m.ProcessCollectionDirectiveCallCount.Add(1)
