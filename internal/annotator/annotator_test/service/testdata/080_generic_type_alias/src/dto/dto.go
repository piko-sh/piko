...
import (
	"testcase_80_generic_type_alias/fields"
)
...
func (p Product) Description() string {
	return p.Name.String() + " - " + p.Price.String()
}

type MemberRef = fields.Ref[TeamMember]

type ProductRef = fields.Ref[Product]

type PageData struct {
	Member       MemberRef              `json:"member"`
	Product      ProductRef             `json:"product"`
	DirectMember fields.Ref[TeamMember] `json:"direct_member"`
}
