						...
						OnEvents: map[string][]ast_domain.Directive{
							"click": []ast_domain.Directive{
								ast_domain.Directive{
									...
									Arg:           "click",
									RawExpression: "update(state.Name, state.Count)",
												...
												Base: &ast_domain.Identifier{
													...
													GoAnnotations: &ast_domain.GoGeneratorAnnotation{
														ResolvedType: &ast_domain.ResolvedTypeInfo{
															...
															CanonicalPackagePath: "testcase_096_client_fn_type_mismatch/dist/pages/main_aaf9a2e0",
															UnderlyingTypeString: "struct{Name string; Count string}",
														},
