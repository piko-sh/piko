...
import "testcase_74_nested_generic_method_resolution/fields"

type TeamMember struct {
	FirstName   fields.Text `json:"first_name"`
	LastName    fields.Text `json:"last_name"`
	PhoneNumber fields.Text `json:"phone_number"`
}
...
type OpenViewingData struct {
	Date         fields.Text            `json:"date"`
	Time         fields.Text            `json:"time"`
	ViewingAgent fields.Ref[TeamMember] `json:"viewing_agent"`
}
