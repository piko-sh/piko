		...
		RootNodes: []*ast_domain.TemplateNode{
			&ast_domain.TemplateNode{
				...
				DirIf: &ast_domain.Directive{
					...
					RawExpression: "props.Data.Member.GetPtr() != nil",
										...
										Base: &ast_domain.Identifier{
											...
											GoAnnotations: &ast_domain.GoGeneratorAnnotation{
												ResolvedType: &ast_domain.ResolvedTypeInfo{
													...
													CanonicalPackagePath: "testcase_76_generic_pointer_return/dist/pages/main_aaf9a2e0",
										...
										Property: &ast_domain.Identifier{
											...
											GoAnnotations: &ast_domain.GoGeneratorAnnotation{
												ResolvedType: &ast_domain.ResolvedTypeInfo{
													...
													PackageAlias:         "dto",
													CanonicalPackagePath: "testcase_76_generic_pointer_return/dto",
													UnderlyingTypeString: "struct{Member fields.Ref[dto.TeamMember]; Optional fields.Optional[dto.TeamMember]}",
												},
												Symbol: &ast_domain.ResolvedSymbol{
													Name: "Data",
													ReferenceLocation: ast_domain.Location{
									...
									Property: &ast_domain.Identifier{
										...
										GoAnnotations: &ast_domain.GoGeneratorAnnotation{
											ResolvedType: &ast_domain.ResolvedTypeInfo{
												...
												PackageAlias:         "fields",
												CanonicalPackagePath: "testcase_76_generic_pointer_return/fields",
					...
					&ast_domain.TemplateNode{
						...
						RichText: []ast_domain.TextPart{
							ast_domain.TextPart{
								...
								RawExpression: "props.Data.Member.GetPtr().FirstName.String()",
					...
					&ast_domain.TemplateNode{
						...
						RichText: []ast_domain.TextPart{
							ast_domain.TextPart{
								...
								RawExpression: "props.Data.Member.GetPtr().FullName()",
								Expression: &ast_domain.CallExpression{
									Callee: &ast_domain.MemberExpression{
										Base: &ast_domain.CallExpression{
											Callee: &ast_domain.MemberExpression{
			...
			&ast_domain.TemplateNode{
				...
				DirIf: &ast_domain.Directive{
					...
					RawExpression: "props.Data.Optional.Value() != nil",
					Expression: &ast_domain.BinaryExpression{
						Left: &ast_domain.CallExpression{
							Callee: &ast_domain.MemberExpression{
								Base: &ast_domain.MemberExpression{
									...
									Property: &ast_domain.Identifier{
										...
										GoAnnotations: &ast_domain.GoGeneratorAnnotation{
											ResolvedType: &ast_domain.ResolvedTypeInfo{
												TypeExpression:       typeExprFromString("fields.Optional[dto.TeamMember]"),
												PackageAlias:         "fields",
												CanonicalPackagePath: "testcase_76_generic_pointer_return/fields",
												UnderlyingTypeString: "struct{value *T}",
											},
											Symbol: &ast_domain.ResolvedSymbol{
												Name: "Optional",
												ReferenceLocation: ast_domain.Location{
					...
					&ast_domain.TemplateNode{
						...
						RichText: []ast_domain.TextPart{
							ast_domain.TextPart{
								...
								RawExpression: "props.Data.Optional.Value().Email.String()",
								Expression: &ast_domain.CallExpression{
									Callee: &ast_domain.MemberExpression{
										Base: &ast_domain.MemberExpression{
											Base: &ast_domain.CallExpression{
