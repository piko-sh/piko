...
// It simulates a simple invocation of a component whose Props struct is intentionally
// malformed with a duplicate `prop` tag. The test's purpose is not to validate this
// specific invocation, but to ensure that the ComponentLinker's setup phase detects
// the invalid Props definition and fails with a clear error.
