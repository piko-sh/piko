...
// It simulates two invocations of a profile component: one with a correctly typed
// struct pointer prop, and one with an incorrectly typed primitive prop. This allows
// the test to validate the ComponentLinker's ability to type-check complex,
				...
				GoAnnotations: &ast_domain.GoGeneratorAnnotation{
					...
					PartialInfo: &ast_domain.PartialInvocationInfo{
						...
						PassedProps: map[string]ast_domain.PropValue{
							"user": {Expression: &ast_domain.MemberExpression{Base: &ast_domain.Identifier{Name: "state"}, Property: &ast_domain.Identifier{Name: "CurrentUser"}}},
						},
					},
				},
			},
			{
				...
				GoAnnotations: &ast_domain.GoGeneratorAnnotation{
					...
					PartialInfo: &ast_domain.PartialInvocationInfo{
						...
						InvokerPackageAlias: mainHash,
						PassedProps: map[string]ast_domain.PropValue{
							"user": {Expression: &ast_domain.MemberExpression{Base: &ast_domain.Identifier{Name: "state"}, Property: &ast_domain.Identifier{Name: "CurrentUserID"}}},
						},
					},
				},
			},
