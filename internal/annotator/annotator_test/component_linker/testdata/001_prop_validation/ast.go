...
// CreateExpansionResult is the new test definition function.
// It receives the fully built VirtualModule, allowing it to use real, dynamically
// generated package hashes instead of hardcoded fakes. Its job is to return the
// precise ExpansionResult DTO to be used as input for the ComponentLinker under test.
				...
				GoAnnotations: &ast_domain.GoGeneratorAnnotation{
					...
					PartialInfo: &ast_domain.PartialInvocationInfo{
						...
						PassedProps: map[string]ast_domain.PropValue{
							...
							"count": {Expression: &ast_domain.MemberExpression{Base: &ast_domain.Identifier{Name: "state"}, Property: &ast_domain.Identifier{Name: "Count"}}},
						},
					},
				},
			},
			{
				...
				GoAnnotations: &ast_domain.GoGeneratorAnnotation{
					...
					PartialInfo: &ast_domain.PartialInvocationInfo{
						...
						InvokerPackageAlias: mainHash,
						PassedProps: map[string]ast_domain.PropValue{
							"title":        {Expression: &ast_domain.MemberExpression{Base: &ast_domain.Identifier{Name: "state"}, Property: &ast_domain.Identifier{Name: "Count"}}},
							"count":        {Expression: &ast_domain.MemberExpression{Base: &ast_domain.Identifier{Name: "state"}, Property: &ast_domain.Identifier{Name: "Title"}}},
							"unknown-prop": {Expression: &ast_domain.BooleanLiteral{Value: true}},
						},
					},
				},
			},
