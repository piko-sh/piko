		...
		RootNodes: []*ast_domain.TemplateNode{
			&ast_domain.TemplateNode{
				...
				GoAnnotations: &ast_domain.GoGeneratorAnnotation{
					...
					PartialInfo: &ast_domain.PartialInvocationInfo{
						InvocationKey:       "card_title_state_titlea_243cc367",
						PartialAlias:        "card",
									...
									Base: &ast_domain.Identifier{
										...
										GoAnnotations: &ast_domain.GoGeneratorAnnotation{
											ResolvedType: &ast_domain.ResolvedTypeInfo{
												...
												CanonicalPackagePath: "testcase_03_invocation_canonicalisation/dist/pages/main_aaf9a2e0",
												UnderlyingTypeString: "struct{TitleA string; TitleB string}",
											},
			...
			&ast_domain.TemplateNode{
				...
				GoAnnotations: &ast_domain.GoGeneratorAnnotation{
					...
					OriginalSourcePath:   new("partials/card.pk"),
					PartialInfo: &ast_domain.PartialInvocationInfo{
						InvocationKey:       "card_title_state_titleb_f02cd4cf",
						PartialAlias:        "card",
						PartialPackageName:  "partials_card_bfc4a3cf",
						InvokerPackageAlias: "main_aaf9a2e0",
						Location: ast_domain.Location{
