...
// It simulates the output of the PartialExpander, providing three partial invocations.
// Two of these invocations are semantically identical (passing the same props), while the
// third is different. This allows the test to verify that the ComponentLinker correctly
// canonicalizes the invocation keys.
func CreateExpansionResult(t *testing.T, vm *annotator_dto.VirtualModule) *annotator_dto.ExpansionResult {
	...
	flattenedAST := &ast_domain.TemplateAST{
		RootNodes: []*ast_domain.TemplateNode{
			{
				NodeType: ast_domain.NodeElement, TagName: "div", Attributes: []ast_domain.HTMLAttribute{{Name: "id", Value: "card1"}},
				GoAnnotations: &ast_domain.GoGeneratorAnnotation{
					...
					PartialInfo: &ast_domain.PartialInvocationInfo{
						...
						PassedProps:         map[string]ast_domain.PropValue{"title": {Expression: &ast_domain.MemberExpression{Base: &ast_domain.Identifier{Name: "state"}, Property: &ast_domain.Identifier{Name: "TitleA"}}}},
					},
				},
			},
			{
				NodeType: ast_domain.NodeElement, TagName: "div", Attributes: []ast_domain.HTMLAttribute{{Name: "id", Value: "card2"}},
				GoAnnotations: &ast_domain.GoGeneratorAnnotation{
					OriginalPackageAlias: &cardHash,
					OriginalSourcePath:   &cardSourcePath,
					PartialInfo: &ast_domain.PartialInvocationInfo{
			...
			{
				NodeType: ast_domain.NodeElement, TagName: "div", Attributes: []ast_domain.HTMLAttribute{{Name: "id", Value: "card3"}},
				GoAnnotations: &ast_domain.GoGeneratorAnnotation{
					OriginalPackageAlias: &cardHash,
					OriginalSourcePath:   &cardSourcePath,
					PartialInfo: &ast_domain.PartialInvocationInfo{
						InvocationKey:       "potential-key-3",
						PartialAlias:        "card",
						PartialPackageName:  cardHash,
						InvokerPackageAlias: mainHash,
						PassedProps:         map[string]ast_domain.PropValue{"title": {Expression: &ast_domain.MemberExpression{Base: &ast_domain.Identifier{Name: "state"}, Property: &ast_domain.Identifier{Name: "TitleB"}}}},
					},
				},
			},
		},
