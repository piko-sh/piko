				...
				Children: []*ast_domain.TemplateNode{
					&ast_domain.TemplateNode{
						...
						DirClass: &ast_domain.Directive{
							...
							RawExpression: "{ 'highlight': state.IsImportant }",
							Expression: &ast_domain.ObjectLiteral{
								Pairs: map[string]ast_domain.Expression{
									"highlight": &ast_domain.MemberExpression{
					...
					&ast_domain.TemplateNode{
						...
						DirStyle: &ast_domain.Directive{
							...
							RawExpression: "{ 'color': state.Color, 'font-weight': state.IsImportant ? 'bold' : 'normal' }",
							Expression: &ast_domain.ObjectLiteral{
								Pairs: map[string]ast_domain.Expression{
									...
									"font-weight": &ast_domain.TernaryExpression{
