			...
			&ast_domain.TemplateNode{
				...
				Children: []*ast_domain.TemplateNode{
					&ast_domain.TemplateNode{
						...
						Children: []*ast_domain.TemplateNode{
							&ast_domain.TemplateNode{
								...
								TextContent: "P-For CSS Scoping Test",
								GoAnnotations: &ast_domain.GoGeneratorAnnotation{
									OriginalPackageAlias: new("pages_main_594861c5"),
									OriginalSourcePath:   new("pages/main.pk"),
									IsStatic:             true,
					...
					&ast_domain.TemplateNode{
						...
						TagName: "div",
						GoAnnotations: &ast_domain.GoGeneratorAnnotation{
							OriginalPackageAlias: new("partials_item_list_1ec6225d"),
							OriginalSourcePath:   new("partials/item_list.pk"),
							PartialInfo: &ast_domain.PartialInvocationInfo{
								InvocationKey:       "item_list_items_state_items_11b0cc04",
								PartialAlias:        "item_list",
								PartialPackageName:  "partials_item_list_1ec6225d",
								...
								Children: []*ast_domain.TemplateNode{
									&ast_domain.TemplateNode{
										...
										DirFor: &ast_domain.Directive{
											...
											RawExpression: "item in props.Items",
												...
												Collection: &ast_domain.MemberExpression{
													Base: &ast_domain.Identifier{
														...
														GoAnnotations: &ast_domain.GoGeneratorAnnotation{
															...
															BaseCodeGenVarName: new("props_item_list_items_state_items_11b0cc04"),
															OriginalSourcePath: new("partials/item_list.pk"),
														},
													},
													Property: &ast_domain.Identifier{
														...
														GoAnnotations: &ast_domain.GoGeneratorAnnotation{
															...
															BaseCodeGenVarName:  new("props_item_list_items_state_items_11b0cc04"),
															OriginalSourcePath:  new("partials/item_list.pk"),
															GeneratedSourcePath: new("dist/partials/partials_item_list_1ec6225d/generated.go"),
															Stringability:       5,
														},
													},
													Optional: false,
