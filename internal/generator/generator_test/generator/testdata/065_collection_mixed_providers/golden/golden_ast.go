						...
						Children: []*ast_domain.TemplateNode{
							...
							&ast_domain.TemplateNode{
								...
								DirFor: &ast_domain.Directive{
									...
									RawExpression: "(i, post) in r.GetCollection[Post](\"blog\")",
										...
										ItemVariable: &ast_domain.Identifier{
											...
											GoAnnotations: &ast_domain.GoGeneratorAnnotation{
												ResolvedType: &ast_domain.ResolvedTypeInfo{
													...
													CanonicalPackagePath: "testcase_065_collection_mixed_providers/dist/pages/pages_main_594861c5",
												},
												Symbol: &ast_domain.ResolvedSymbol{
													Name: "post",
													ReferenceLocation: ast_domain.Location{
						...
						Children: []*ast_domain.TemplateNode{
							...
							&ast_domain.TemplateNode{
								...
								Attributes: []ast_domain.HTMLAttribute{
									ast_domain.HTMLAttribute{
										Name:  "condition",
										Value: "len(r.GetCollection[Post](&quot;blog&quot;)) > 0",
										Location: ast_domain.Location{
											Line:   33,
											Column: 24,
										},
											...
											&ast_domain.TemplateNode{
												...
												Children: []*ast_domain.TemplateNode{
													&ast_domain.TemplateNode{
														...
														TextContent: "First post title from collection",
														GoAnnotations: &ast_domain.GoGeneratorAnnotation{
															OriginalPackageAlias: new("pages_main_594861c5"),
															OriginalSourcePath:   new("pages/main.pk"),
															IsStatic:             true,
