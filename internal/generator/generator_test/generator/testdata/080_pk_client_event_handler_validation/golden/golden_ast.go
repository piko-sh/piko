					...
					&ast_domain.TemplateNode{
						...
						Children: []*ast_domain.TemplateNode{
							&ast_domain.TemplateNode{
								...
								TextContent: "PPFT Client Event Handler Validation Test",
								GoAnnotations: &ast_domain.GoGeneratorAnnotation{
									OriginalPackageAlias: new("pages_main_594861c5"),
									OriginalSourcePath:   new("pages/main.pk"),
									IsStatic:             true,
					...
					&ast_domain.TemplateNode{
						...
						Children: []*ast_domain.TemplateNode{
							&ast_domain.TemplateNode{
								...
								TextContent: " This page tests that client-side event handlers are properly validated against exported functions from the TypeScript client script block. ",
								GoAnnotations: &ast_domain.GoGeneratorAnnotation{
									OriginalPackageAlias: new("pages_main_594861c5"),
									OriginalSourcePath:   new("pages/main.pk"),
									IsStatic:             true,
						...
						OnEvents: map[string][]ast_domain.Directive{
							"submit": []ast_domain.Directive{
								ast_domain.Directive{
									...
									Arg:           "submit",
									RawExpression: "handleSubmit($event)",
									Expression: &ast_domain.CallExpression{
										Callee: &ast_domain.Identifier{
											Name: "handleSubmit",
											RelativeLocation: ast_domain.Location{
					...
					&ast_domain.TemplateNode{
						...
						OnEvents: map[string][]ast_domain.Directive{
							"click": []ast_domain.Directive{
								ast_domain.Directive{
									...
									Arg:           "click",
									Modifier:      "action",
									RawExpression: "action.deleteUser()",
									Expression: &ast_domain.CallExpression{
										Callee: &ast_domain.Identifier{
											Name: "deleteUser",
											RelativeLocation: ast_domain.Location{
						...
						Children: []*ast_domain.TemplateNode{
							&ast_domain.TemplateNode{
								...
								TextContent: " Delete (Server Action) ",
								GoAnnotations: &ast_domain.GoGeneratorAnnotation{
									OriginalPackageAlias: new("pages_main_594861c5"),
									OriginalSourcePath:   new("pages/main.pk"),
									IsStatic:             true,
