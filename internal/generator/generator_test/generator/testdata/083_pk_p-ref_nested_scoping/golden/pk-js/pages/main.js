...
async function __createInstance__(__scope__) {
  ...
  return { focusPageInput };
}
export async function focusPageInput(event, ...args) {
  return (await __getInstance__(event)).focusPageInput(...args);
}
getGlobalPageContext().setExports({ focusPageInput });
{
