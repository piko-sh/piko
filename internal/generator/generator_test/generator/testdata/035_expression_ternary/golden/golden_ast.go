					...
					&ast_domain.TemplateNode{
						...
						DynamicAttributes: []ast_domain.DynamicAttribute{
							ast_domain.DynamicAttribute{
								Name:          "class",
								RawExpression: "state.IsActive ? 'status-active' : 'status-inactive'",
										...
										Base: &ast_domain.Identifier{
											...
											GoAnnotations: &ast_domain.GoGeneratorAnnotation{
												ResolvedType: &ast_domain.ResolvedTypeInfo{
													...
													CanonicalPackagePath: "testcase_035_expression_ternary/dist/pages/pages_main_594861c5",
													UnderlyingTypeString: "struct{IsActive bool}",
												},
							...
							&ast_domain.TemplateNode{
								...
								RichText: []ast_domain.TextPart{
									...
									ast_domain.TextPart{
										...
										RawExpression: "state.IsActive ? 'Active' : 'Inactive'",
										Expression: &ast_domain.TernaryExpression{
											Condition: &ast_domain.MemberExpression{
												Base: &ast_domain.Identifier{
													Name: "state",
