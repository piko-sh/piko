				...
				Children: []*ast_domain.TemplateNode{
					...
					&ast_domain.TemplateNode{
						...
						DirIf: &ast_domain.Directive{
							...
							RawExpression: "state.StatusA == state.StatusB",
									...
									Base: &ast_domain.Identifier{
										...
										GoAnnotations: &ast_domain.GoGeneratorAnnotation{
											ResolvedType: &ast_domain.ResolvedTypeInfo{
												...
												CanonicalPackagePath: "testcase_151_defined_type_equality_stringable/dist/pages/pages_main_594861c5",
												UnderlyingTypeString: "struct{StatusA pages_main_594861c5.ResultStatus; StatusB pages_main_594861c5.ResultStatus}",
											},
