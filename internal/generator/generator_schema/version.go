...
var (
	...
	// SchemaHash is the SHA-256 hash of manifest.fbs, computed at init time. This hash
...
// Pack wraps a serialised Manifest FlatBuffer with the schema version hash. The returned
