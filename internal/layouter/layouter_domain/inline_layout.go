...
func (c *inlineLayoutContext) layoutWrappedTextRun(
	...
	if !state.segmentEmpty {
		c.emitTextSegment(child, font, fontSize, state.segmentText, state.segmentStartX, textLineHeight, verticalAlignInputs{parentMetrics: parentMetrics, effective: effectiveVA})
	}
}
