...
// FindPackageVariable finds a package-level variable or constant in a given package. It
...
// resolution.
//
// Returns *inspector_dto.Variable which contains the variable's information, or nil if
...
// FindPackageVariableType is a convenience wrapper around FindPackageVariable that
// returns the type string of a package variable.
//
...
// the variable's package alias.
//
// Returns string which is the type string of the variable, or empty string if the
