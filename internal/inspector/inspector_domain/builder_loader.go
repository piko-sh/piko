...
//
// Benign errors and non-root non-list errors are always skipped; type and parse errors
// are skipped when best-effort introspection is enabled; only list errors and untolerated
// root errors abort.
//
