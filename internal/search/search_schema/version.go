...
var (
	//go:embed search_index.fbs
	schemaContent []byte

	// SchemaHash is the SHA-256 hash of search_index.fbs, computed at init time. This hash
...
// Pack wraps a serialised Search FlatBuffer with the schema version hash. The returned
