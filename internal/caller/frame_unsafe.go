...
//
// Must be kept in sync with Go's internal implementation. The layout was verified against
// Go 1.23 and later versions. The nextPC field was added in Go 1.23 to support improved
// inlining information.
//
// IMPORTANT: Field order is load-bearing - it must match runtime.Frames exactly. Do NOT
// reorder these fields. The struct is cast via unsafe.Pointer.
//
...
// counter.
//
// Builds a runtime.Frames struct on the stack to avoid heap allocation. It then casts the
// struct to *runtime.Frames and calls Next() to get the frame details.
//
