// Package db provides embedded MySQL migration and seed files for the blog database. Pass
// Migrations as the MigrationFS field and Seeds as the SeedFS field in a
