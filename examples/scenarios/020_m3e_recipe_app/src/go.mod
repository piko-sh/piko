...
replace (
	piko.sh/piko => ../../../../
	piko.sh/piko/wdk/llm/llm_provider_zoltai => ../../../../wdk/llm/llm_provider_zoltai
	piko.sh/piko/wdk/markdown/markdown_provider_goldmark => ../../../../wdk/markdown/markdown_provider_goldmark
)
