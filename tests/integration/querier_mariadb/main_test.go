...
func TestMain(m *testing.M) {
	...
	container, connectionString, err := startMariaDBContainer(ctx)
	if err != nil {
		log.Fatalf("starting mariadb container: %v", err)
	}
	...
	if mariadbContainer != nil {
		_ = mariadbContainer.Terminate(context.Background())
	}
...
func TestQuerierMariaDBIntegration(t *testing.T) {
	if testing.Short() {
