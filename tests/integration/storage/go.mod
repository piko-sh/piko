module piko.sh/piko/tests/integration/storage
...
require (
	...
	piko.sh/piko/wdk/storage/storage_transformer_gzip v0.0.0
	piko.sh/piko/wdk/storage/storage_transformer_zstd v0.0.0
)
