...
func TestDynamoDB_BasicSetGet(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()

	namespace := uniqueKey(t, "basic") + ":"
	c := createDynamoDBStringCache(t, namespace)
	ctx := testContext(t)
...
func TestDynamoDB_EmptyStringValue(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
...
func TestDynamoDB_UnicodeValues(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
...
func TestDynamoDB_Invalidate(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
...
func TestDynamoDB_TTL_Expiry(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
...
func TestDynamoDB_Compute(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
...
func TestDynamoDB_BulkSetAndGet(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
...
func TestDynamoDB_InvalidateByTags(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
...
func TestDynamoDB_LargeValue(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()

	namespace := uniqueKey(t, "large") + ":"
	c := createDynamoDBStringCache(t, namespace)
	ctx := testContext(t)

	largeValue := strings.Repeat("x", 100_000)
	err := c.Set(ctx, "large-key", largeValue)
	require.NoError(t, err)

	val, ok, err := c.GetIfPresent(ctx, "large-key")
	require.NoError(t, err)
	assert.True(t, ok)
	assert.Equal(t, largeValue, val)
}

func TestDynamoDB_Concurrency_ParallelSetGet(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
...
func TestDynamoDB_Overwrite(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
...
func TestDynamoDB_InvalidateAll(t *testing.T) {
	skipIfNoDynamoDB(t)
	t.Parallel()
