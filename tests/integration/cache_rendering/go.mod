...
// Package cache_rendering contains integration tests for cache rendering
// parity across no-cache, AST-cache and static-cache modes.
module piko.sh/piko/tests/integration/cache_rendering
